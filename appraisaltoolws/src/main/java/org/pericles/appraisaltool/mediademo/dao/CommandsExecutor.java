...
public interface CommandsExecutor {
	...
	void deleteArtworks(LinkedList<String> artworkNames);
	...
	String getAllComputerNames();
	
	String getAllContainerFormatNames();
	
	String getAllOperatingSystemNames();
	
	String getAllVideoCodecNames();

	String getAllVideoPlayerNames();
	
	//LinkedList<String> getAllArtworkNames();

	String getArtworkID(String artworkName);
	...
	boolean isComponentExisted(String componentName);
